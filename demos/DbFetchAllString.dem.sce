...
database = get_absolute_file_path("DbFetchAllString.dem.sce") + "addressbook";
...
disp("resultStrings  = DbFetchAllString(resultHandler)");
resultStrings = DbFetchAllString(resultHandler);
disp(resultStrings , "resultStrings =");
